...
class ComUefiShellProvider(BaseUefiShellProvider):
    """
    ...
    def __init__(self, cfg_opts, log):
        ...
        """
        super(ComUefiShellProvider, self).__init__(cfg_opts, log)

    def __enter__(self):
        return super(ComUefiShellProvider, self).__enter__()

    def __exit__(self, exc_type, exc_val, exc_tb):
        super(ComUefiShellProvider, self).__exit__(exc_type, exc_val, exc_tb)
