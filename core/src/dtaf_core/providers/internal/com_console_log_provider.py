...
class ComConsoleLogProvider(BaseConsoleLogProvider):
    """
    ...
    def __init__(self, cfg_opts, log):
        ...
        """
        super(ComConsoleLogProvider, self).__init__(cfg_opts, log)

    def __enter__(self):
        return super(ComConsoleLogProvider, self).__enter__()

    def __exit__(self, exc_type, exc_val, exc_tb):
        super(ComConsoleLogProvider, self).__exit__(exc_type, exc_val, exc_tb)
