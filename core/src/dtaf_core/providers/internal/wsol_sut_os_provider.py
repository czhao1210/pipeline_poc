...
class WsolSutOsProvider(BaseSutOsProvider):
    """
    ...
    def __init__(self, cfg_opts, log):
        ...
        """
        super(WsolSutOsProvider, self).__init__(cfg_opts, log)

    def __enter__(self):
        return super(WsolSutOsProvider, self).__enter__()

    def __exit__(self, exc_type, exc_val, exc_tb):
        super(WsolSutOsProvider, self).__exit__(exc_type, exc_val, exc_tb)
