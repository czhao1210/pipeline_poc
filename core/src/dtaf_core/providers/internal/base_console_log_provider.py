...
#################################################################################
"""
This Module is the base implementation of Console Log Provider
"""
import os
import re
import sys
...
from dtaf_core.lib.exceptions import InvalidParameterError, IncorrectKeyException
from dtaf_core.providers.log import LogProvider


class BaseConsoleLogProvider(LogProvider):
    """
    ...
    def __init__(self, cfg_opts, log):
        ...
        """
        super(BaseConsoleLogProvider, self).__init__(cfg_opts, log)
    ...
    def __enter__(self):
        return super(BaseConsoleLogProvider, self).__enter__()
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        self.close()
        super(BaseConsoleLogProvider, self).__exit__(exc_type, exc_val, exc_tb)
    ...
    def wait_for_keyword(self, pattern, timeout):
        ...
        while (datetime.now() - start_time).seconds < timeout:
            content = self.serial.read_from(self.keyword_buffer)
            data += content
