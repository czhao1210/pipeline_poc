...
class WsolConsoleLogProvider(BaseConsoleLogProvider):
    """
    ...
    def __init__(self, cfg_opts, log):
        ...
        """
        super(WsolConsoleLogProvider, self).__init__(cfg_opts, log)

    def __enter__(self):
        return super(WsolConsoleLogProvider, self).__enter__()

    def __exit__(self, exc_type, exc_val, exc_tb):
        super(WsolConsoleLogProvider, self).__exit__(exc_type, exc_val, exc_tb)
