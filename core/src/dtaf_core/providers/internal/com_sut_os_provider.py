...
class ComSutOsProvider(BaseSutOsProvider):
    """
    ...
    def __init__(self, cfg_opts, log):
        ...
        """
        super(ComSutOsProvider, self).__init__(cfg_opts, log)

    def __enter__(self):
        return super(ComSutOsProvider, self).__enter__()

    def __exit__(self, exc_type, exc_val, exc_tb):
        super(ComSutOsProvider, self).__exit__(exc_type, exc_val, exc_tb)
    ...
    def update_configuration(self, update_cfg_opts, update_log):
        self.close()
        super(ComSutOsProvider, self).update_configuration(update_cfg_opts=update_cfg_opts,
