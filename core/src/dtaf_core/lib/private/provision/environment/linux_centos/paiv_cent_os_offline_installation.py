...
class Os_Installation(BaseTestCase):
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        self._centos_cfg_file_name = arguments.post_os_automation_enabler_cent
    ...
    def add_arguments(cls, parser):
        ...
        parser.add_argument('--CENTOS_CFG_FILE_NAME', action="store", dest="post_os_automation_enabler_cent",
                            default="centOS8-auto.cfg",
                            help="CFG file in Software Package will be Additionally Added with AutomationEnabler Functionality, Please Give the correct CFG file,by default it is centOS8-auto.cfg for CENTOS")
