...
class TestSuites(object):
    def test_ac_on(self):
        ...
        bios = ProviderFactory.create(bioscfg, log)  # type:BiosProvider
        phy = ProviderFactory.create(phycfg, log) # type: PhysicalControlProvider
        print(phy.get_system_id())
        # print("get boot order={}".format(bios.get_boot_device()))
        # print(bios.select_boot_device("BiosSetup"))
        # print("get boot order={}".format(bios.get_boot_device()))
        # print(bios.select_boot_device("Hdd"))
        # print("get boot order={}".format(bios.get_boot_device()))
        print("PASSED")
