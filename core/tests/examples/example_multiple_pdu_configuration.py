...
class AcPowerSystemTest(BaseTestCase):
    ...
    def verify_multi_pdu(self):
        """
        This is the function to verify ac functionality of multi pdu
        :return: None
        """
        assert self._ac.ac_power_off(10)
        assert not self._ac.get_ac_power_state()
        assert self._ac.ac_power_on(10)
